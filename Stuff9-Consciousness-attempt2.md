...
1. $\mathbf{P}((c, h^{(n)}) \sim \mathrm{R}^n(m, \emptyset) \vert c, \mathrm{R})$
2. $\mathbf{P}((c, h^{(n)}) \sim \mathrm{R}^n(r, \emptyset) \vert c, \mathrm{R})$
3. $\mathbf{P}((c, h^{(n)}) \sim \mathrm{R}^n((m, r), \emptyset) \vert c, \mathrm{R})$
