...
I wrote that paper in the same year as the benzo brain damage that stopped me from working on that direction. That reddit post from >3 years ago was my best summary of all of my trauma, and it was deleted. I have no backup in my notes. It was up just 5 months ago. Same with the CMT record of the paper. Microsoft emailed just months ago that, since conferences have switched from CMT to OpenReview, that they would be purging all of those records. Trauma and achievement both buried as if they didn't happen.
