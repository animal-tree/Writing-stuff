Arithmetic (numbers and functional relationships) -> Algebra (variables) -> Calculus (how those variables change at different points, and how those changes change, etc.) -> Optimization or decision (how to change those variables at different points towards a teleology, a goal, a objective, or by some will or order) A.K.A. intelligence/consciousness/singularizing-experience-and-distributed-intelligence. 
