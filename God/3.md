...
It’s a self-complete theory from which the only[^1] escape is distraction or axiomatically assuming it’s less true than the only other alternative, which is, too optimistic and too insane/ambitious for attainment*. Or suicide. Or maybe a good enough distraction that negates one’s concerns about the possibility of -all- of this. 

*maybe

[^1]: As for medical institutions, those have disproven themselves. Just speaking for myself and not other patients, here are some of the situations that would have been avoided had I never stepped near the university's medical centers: induced full-body baldness, brain damage (yep), full-body eczema, seeing how dumb administrators in my own PhD program have been, tons of actual malpractice (such as those first two, but for example them running over my big toe in the wheelchair and ignoring it as I screamed), and so much terrifyingly more. I did therapy for more than a year as well though and got a clean bill of health as far as he could help, oh and an actual bill of several hundred dollars. As for the emergent psychological issues that I notably didn't have prior to the medical center intervention, it's very possible given these evidenced statistical anomolies that I was right on even that front regarding my diagnosed-manic(?)/autistic(?) percetions. (Note: of any diagnosis, schizotypal personality disorder or just social anxiety would've been most accurate).
