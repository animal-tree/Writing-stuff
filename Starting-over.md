...
> A teleological explanation isn't new to physics. After all, the Hamiltonian can be thought of as a teleological explanation, in a sense. Ideas like "principle of least action" almost imply an objective, but, as we've seen, have alternative more causal ways of interpreting. Similarly, any such teleological objective proposed here can also have an alternate perspective such as, evolutionary emergence.
