...
Unlike fission, fussion, anf unrenewable, unsustainable energy sources, "fire" in the primitive sense of our ancestor-paleolithic days in nature, is, vaporized regular H20, with no-neutrons, water (enchanted by the power of electrons swarming out of its unstable shell, with residue and sustainable levels of CO2 that the trees can breathe).
