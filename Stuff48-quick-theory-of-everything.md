...
6. In addition to waves in the photon-composed aether (dark matter), each collision produces a variational sample set of waves and truncates old ones. This is a computationally efficient optimization technique.
7. The universe is (slowly) optimizing qualia, which entangles into higher forms of consciousness.
