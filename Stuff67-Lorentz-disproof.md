...
(Appending to **Definitions** <br>$\text{Relay station hoop}$: just a hoop whose exact center is located at position 1 in coordinate system 1 and is stationary relative to coordinate system 1, orthogonal to the x-axes of the collinear coordinate systems $i \leq N$).
