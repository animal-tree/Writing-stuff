...
A little more precise: the effect between the intermediary particles would be non-zero. However, their effect on teh first body, without the cross-derivative interaction with a second body, would be zero.
