...
These and similar form an isotropic basis for an anisotropic universe. Menawhile, those that do not undergo time dilation (due to anisotropic orbits), perhaps length contraction (due to changing radii).
