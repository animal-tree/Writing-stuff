...
> This is a thought experiment about whether special and general relativity could emerge relativistically from an angular-linear velocity tradeoff in a universe who particles and bodies consisted of "corpuscles" all traveling at the same absolute speed consistent but just with varying directions (varying angular/orbital patterns detracting from perceptible linear speed).
