...
Then rather than rising out of nothing, it arose from the combination of the three. Physical reality $\Omega$ representing anything, or the limits of representational space. Qualia $\alpha$ representing everything, or $\mathbb{N}$ applied to observation $I$. $\emptyset$ representing nothing.
