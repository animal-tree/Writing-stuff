...
In reality, given already a sufficiently high N and high-quality data: a purposeful experiment which follows a purposeful prediction, is redundant and provides no information gain compared to the existing data, except perhaps on the role of purpose/human-intent in influencing the measurement. In the study of consciousness and wave-particle properties in quantum mechanics, this may be relevant, arguably. However, let’s look into that a bit closer as well to make sure we’re not conflating measurement intent and measurement bias.
